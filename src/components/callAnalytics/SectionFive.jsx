...
function SectionFive({ revenueAndCustomerSectionData }) {
  return (
    <div>
      {" "}
      <div className="grid grid-cols-2 gap-4   pb-0">
        <div className="bg-white rounded-lg py-8">
          <h2 className="text-lg font-bold mb-8 text-[#1F3B59] text-start px-8">
            Customers
          </h2>
          <div className="pb-1 grid grid-cols-2 relative">
            <div className="mx-5">
              <div className="text-center  border-b-2 pb-[5px]">
                <div className="w-[11rem] h-64 bg-[#0DA452] rounded-md mx-auto mt-4 relative">
                  <div
            ...
            <div className="mx-5 ">
              <div className=" text-center  border-b-2  pb-[5px]">
                ...
                {/* h-[250px]==100 */}
                <div
                  className="w-[11rem] h-[250px] bg-[#70D7FF] rounded-md mx-auto mt-4 relative "
                  data-tooltip-target="tooltip-light"
                ></div>
              </div>
              <div className="flex items-center justify-center pt-6  max-w-[210px] mx-auto">
                <h5 className="flex items-center mb-2 mr-10">
                  ...
                  <span className="text-[#0F2E60]  text-md">Unclassified</span>
                </h5>
              </div>
            </div>
          </div>
