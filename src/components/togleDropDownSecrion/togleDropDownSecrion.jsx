                            ...
                            <tr className=" border-b transition duration-300 ease-in-out  text-white ">
                              ...
                              <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                ...
                                <select
                                  name=""
                                  id=""
                                  className="bg-gray-200 w-full rounded text-gray-900 shadow-r-lg space-y-1 px-1 "
                                >
                                  <option className="bg-white w-full" value="yes">
                                    Yes
                                  </option>
                                  <option className="bg-white w-full" value="no">
                                    No
                                  </option>
                                </select>
                              </td>
