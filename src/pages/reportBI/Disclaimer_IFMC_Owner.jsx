...
export default function Disclaimer_IFMC_Owner() {
  return (
    <body class="bg-gray-100 font-sans">
      <div class="container mx-auto p-6 bg-white shadow-md mt-10 max-w-2xl">
        {/* <h2 class="text-2xl font-bold mb-4"> */}
        <p>
          BY CLICKING ON THE “I AGREE” BUTTON OR BY ACCESSING THE BETA PRODUCT,
        ...
        <p>
          This BETA TEST AGREEMENT (the “Agreement”) is by and between Iron Fist
        ...
        <p>
          ...
          disassemble, decompile, reverse engineer, rent, lease, loan, transfer,
          or make copies of the Beta Product.
        </p>
        <br />
        ...
        <p>
          ...
          IFMC or IFMC’s partners. Except for those rights expressly granted
        ...
        <p>
          ...
          documentation, and all information disclosed by IFMC to You hereunder
          ...
          to or obtained from the Beta Product, is “Confidential Information” of
          IFMC. You will not use the Confidential Information except as
          ...
          use all reasonable steps to protect the Confidential Information from
          unauthorized use or disclosure. Confidential Information does not
          include information that: (1) was rightfully known by You at the time
          of disclosure without an obligation of confidentiality, (2) is
          lawfully obtained by You from a third party without restriction on use
          or disclosure, or (3) is or becomes generally known to the public
        ...
        <p>
          This Agreement shall terminate upon the release by IFMC of a publicly
          available version of the Beta Product, or upon written notice from
          IFMC to You. IFMC does not guarantee that any such publicly available
        ...
        <p>
          ...
          Product including, without limitation, personal information. IFMC may
          ...
          troubleshoot issues, provide updates, analyze trends and improve IFMC
          products or services. IFMC shall be allowed to use such data and share
          such data with IFMC partners for the program purposes. You hereby
          consent to IFMC processing and transferring this information,
          including, if any, personal information, in conformity with the IFMC
          Privacy Policy, as updated from time to time. Further, You shall
          provide feedback to IFMC concerning the functionality and performance
          of the Beta Product from time to time as reasonably requested by IFMC,
          ...
          the IFMC devices. Feedback provided to IFMC through any of the
          foregoing methods in connection with the Beta Product may be used by
          IFMC and its partners to improve or enhance products, services and/or
          features and, accordingly, IFMC shall have a non-exclusive, perpetual,
        ...
        <p>
          ...
          EVALUATION ONLY. THE BETA PRODUCT IS PROVIDED “AS IS” WITHOUT WARRANTY
          OF ANY KIND, WHETHER EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE. IFMC
        ...
        <p>
          ...
          AGREEMENT SHALL NOT EXCEED $100. IN NO EVENT SHALL IFMC HAVE LIABILITY
          FOR ANY INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES, EVEN
          IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. THESE LIMITATIONS SHALL
        ...
        <p>
          This Agreement shall be governed by the laws of North Carolina without
          ...
          without the prior written consent of IFMC. You shall comply in all
